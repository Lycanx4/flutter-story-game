...
class StoryBrain {
  ...
  String getStory(){
    return _storyData[_styNum].storyTitle;
  }

  String getChoice1(){
    return _storyData[_styNum].choice1;
  }

  String getChoice2(){
    return _storyData[_styNum].choice2;
  }
  ...
  }else if(_styNum == 1 && num==1){
    _styNum=2;
  }else if(_styNum == 1 && num==2){
    _styNum=3;
  }else if(_styNum == 2 && num==1){
    _styNum=5;
  }else if(_styNum == 2 && num==2){
    _styNum=4;
  }else if(_styNum==3 || _styNum==4 || _styNum==5){
    reset();
  }
  ...
  bool buttonShouldBeVisible(){
    if(_styNum == 0 || _styNum == 1 || _styNum == 2){
      return true;
    }
    return false;
  }
